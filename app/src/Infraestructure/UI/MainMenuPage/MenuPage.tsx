...
import DataTableContainer from './Datatable/DataTableComponent';
        ...
        <div className="Sidebar">
          <div className="Logo_content">
            ...
            <ul className="nav_list">
              ...
              <ClientsModal isOpen={isModalOpen} toggleModal={toggleModal} />
        </div>
        <div className="Home_content">
              <div className="text">Home Content</div>
              <div className="data-table-wrapper">
                  {showDataTable && <DataTableContainer parameters="pepe" />}
              </div>
        </div>
      </div>
  );
